...
class Portfolio
{
	...
	public:
		Portfolio(std::vector< std::vector<double> > inSampleReturn, std::vector< double > matrixOfCompanyMeanRet, int noOfCompany, int inSampleRollingWindowSize, int numberOfDays, int outOfSampleRollingWindowSize, double noOfTargetReturn, std::vector<std::vector<double> > outOfSampleReturn);
